...
<div class="right">
    <div class="location">
        ...
        <span>通知管理页面 >> 通知添加页面</span>
    </div>
    <div class="providerAdd">
        <form id="billForm" name="billForm" method="post" action="${pageContext.request.contextPath }/message/addMessage">
            <!-- 通知管理对应的type为3 -->
...
<script type="text/javascript" src="/js/messageAdd.js"></script>
