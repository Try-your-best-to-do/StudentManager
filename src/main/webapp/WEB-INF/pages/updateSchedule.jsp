...
<div class="right">
    <div class="location">
        ...
        <span>日程管理页面 >> 日程修改页面</span>
    </div>
    <div class="providerAdd">
        <form id="billForm" name="billForm" method="post" action="${pageContext.request.contextPath }/event/updateEvent1">
            <!-- 日程管理对应的type为2 -->
            <input type="hidden" name="type" value="2">
            <input type="hidden" name="student_id" id="student_id" value="2">
